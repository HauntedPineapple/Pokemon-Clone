...
namespace PokeTheDex
{
    class Pokemon
    {
        ...
        // Monotype pokemon
        public Pokemon(string name, int hp, int atk, int spAtk, int def, int spDef, int speed, Type type, string ability = "")
        {
            this.name = name;
            this.hp = hp;
            attack = atk;
        ...
        // Two-type pokemon
        public Pokemon(string name, int hp, int atk, int spAtk, int def, int spDef, int speed, Type type1, Type type2, string ability = "")
        {
            this.name = name;
            this.hp = hp;
            attack = atk;
